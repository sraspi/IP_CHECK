...
data = "/home/pi/stta/data/" + "TGZ_18_" + timestr+ ".txt"
f = open(data,  "w")
...
fig.canvas.manager.set_window_title("TGZ 18")
...
(vol_line,) = ax.plot(x, y, label="TGZ 18 Gasvolumen", color="#00549F", marker=".") #00549F is the RWTH blue color
ax.set_ylabel("TGZ 18 Gasvolumen in L", color="#00549F")
